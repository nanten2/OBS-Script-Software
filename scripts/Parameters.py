...
class Parameters:
    ...
    Dict Keys:
        ...
        "string" : bool
            If True, the output is string type in OBS, not numerical types
        "no." : int
    ...
    def __init__(self):
        ...
        self.paramlist.append(["scan_property", [
            ...
            {"name": "scan_spacing", "#": "Scan spacing (default = 60arcsec)", "string": False, "unit": "arcsec", "default": 60, "grid": (2,0), "no.": 3},
            {"name": "scan_length", "#": "time duration for 1 scan  (s) ", "string": False, "unit": "s", "grid": (1,1), "no.": 4},
            {"name": "scan_velocity", "#": "scan velocity (default = 600arcsec/s) (<=600)", "string": False, "unit": "arcsec/s", "default": 600, "grid": (2,1), "no.": 5},
            {"name": "integ_on", "#": "ON point integratoin time (s)", "string": False, "unit": "s", "grid": (3,0), "no.": 6}
        ]])
        self.paramlist.append(["calibration", [
            {"name": "integ_off", "#": "OFF point integration time (s)", "string": False, "unit": "s", "no.": 1},
            {"name": "integ_hot", "#": "hot-load integration time (s)", "string": False, "unit": "s", "no.": 2},
            {"name": "off_interval", "#": "off interval (number of scan lines: default = 1)", "string": False, "default": 1, "no.": 3},
            {"name": "load_interval", "#": "time interval of hot-load measurements (min)", "string": False, "unit": "min", "no.": 4}
        ]])
